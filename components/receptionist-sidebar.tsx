...
import { Scale, Users, Calendar, FolderOpen, LogOut } from "lucide-react"
...
const menuItems = [
  { icon: Users, label: "Cadastro de Clientes", href: "/recepcionista" },
  { icon: Calendar, label: "Agendamentos", href: "/recepcionista/agendamentos" },
  { icon: FolderOpen, label: "Progresso de Casos", href: "/recepcionista/casos" },
]

export function ReceptionistSidebar({ open }: ReceptionistSidebarProps) {
  return (
    <aside
      className={cn(
      ...
      <div className="p-6 border-b border-sidebar-border">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-sidebar-foreground/70">Recepção</p>
          </div>
        </div>
      </div>
