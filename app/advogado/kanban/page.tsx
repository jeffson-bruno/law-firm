    ...
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground text-pretty">Organize e acompanhe tarefas e prazos processuais</p>
        </div>
        <Dialog>
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>Crie uma nova tarefa no quadro Kanban</DialogDescription>
            </DialogHeader>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-muted-foreground">
                Você será notificado sobre prazos críticos e atualizações de tarefas
              </p>
            </div>
          </div>
        </CardContent>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Dicas de Uso do Kanban</CardTitle>
        </CardHeader>
        <CardContent>
          <ul className="space-y-2 text-sm text-muted-foreground">
            <li className="flex items-start gap-2">
              <span className="text-primary">•</span>
              <span>Arraste e solte tarefas entre as colunas para atualizar seu status</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-primary">•</span>
              <span>Tarefas com borda vermelha são de alta prioridade e precisam de atenção imediata</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-primary">•</span>
              <span>Use o menu (três pontos) em cada tarefa para editar, duplicar ou excluir</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-primary">•</span>
              <span>Você receberá notificações quando outros advogados ou admins atualizarem tarefas</span>
            </li>
          </ul>
        </CardContent>
      </Card>
